...
<html>
<head>
    <title>StreamingTools - Logged Out</title>
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="https://gfaundead.stream">StreamingTools</a>
        </div>
        <ul class="nav navbar-nav">
            <li><a href="login.php">Login</a></li>
            <li class="active"><a href="loggedout.php">Logged Out</a></li>
        </ul>
        <p class="navbar-text navbar-right">&copy; <?php echo date("Y"); ?> StreamingTools. All rights reserved.</p>
    </div>
</nav>
<h1>You have been successfully logged out of the mods dashboard.</h1>
</body>
</html>